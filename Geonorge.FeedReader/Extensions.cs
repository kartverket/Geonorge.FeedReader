...
namespace Geonorge.FeedReader
{
    /// <summary>
    ///     Extension methods
    ///     Copied from the FeedReader-library. This allows building our extension in the same way as the rest of the library.
    ///     https://github.com/codehollow/FeedReader/blob/19cdb3cb11cf2c8f8e0f49eecbf262d0e5d56d23/FeedReader/Extensions.cs
    /// </summary>
    internal static class Extensions
    {
        ...
        public static XAttribute GetAttribute(this XElement element, string namespacePrefix, string name)
        {
            ...
            XNamespace namesp = element.GetNamespacePrefix(namespacePrefix);
        ...
        {
            XNamespace namesp = string.IsNullOrWhiteSpace(namespacePrefix)
